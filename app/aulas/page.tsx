  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header">
        ...
        <h1 className="section-title text-4xl">Aulas Virtuales</h1>
        <p className="section-subtitle">
          Sesiones de aprendizaje en vivo y grabadas sobre temas que importan a la diáspora venezolana.
          Aprende, comparte y construye conocimiento colectivo.
        </p>
      </div>

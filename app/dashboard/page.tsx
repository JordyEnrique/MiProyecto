  ...
  return (
    <div className="page-container">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-500 text-lg">Bienvenido a Mi Cuenta — tu plataforma de la diáspora venezolana</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        {[
          ...
          { label: 'Días en Mi Cuenta', value: '1', icon: '⭐', change: 'Bienvenido' },
        ].map((stat, i) => (
